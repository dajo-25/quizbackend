...
fun Application.configureGeneratedRoutes(authService: AuthService, questionsService: QuestionsService, collectionsService: CollectionsService, communitiesService: CommunitiesService, marksService: MarksService, devicesService: DevicesService, profileService: ProfileService) {
    val routes = listOf(
        ...
        defineRoute<RespondFriendRequestRequestDTO, EmptyParamsDTO, GenericResponseDTO>(HttpMethod.Post, "/communities/friend-request/respond", requiresAuth = true) { body, params -> communitiesService.PostRespond(body, params) },
        defineRoute<EmptyRequestDTO, EmptyParamsDTO, FriendRequestListResponseDTO>(HttpMethod.Get, "/communities/friend-requests", requiresAuth = true) { body, params -> communitiesService.GetFriendRequests(body, params) },
