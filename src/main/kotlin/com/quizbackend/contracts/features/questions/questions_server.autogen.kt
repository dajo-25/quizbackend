...
interface QuestionsService {
    ...
    suspend fun CreateQuestions(body: CreateQuestionsRequestDTO): DTOResponse<Void>
    ...
    suspend fun DeleteQuestion(id: Int, body: EmptyRequestDTO, params: DeleteQuestionParamsDTO): DTOResponse<Void>
}
