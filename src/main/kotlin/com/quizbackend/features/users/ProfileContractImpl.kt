...
class ProfileContractImpl : ProfileService {
    ...
    override suspend fun SeeProfile(body: EmptyRequestDTO): DTOResponse<ProfileDataResponseDTO> {
        return DTOResponse(true, ProfileDataResponseDTO(ProfileDataDTO(1, "mock@email.com", "mockUser", "Mock", "User")), null)
    }

    override suspend fun UpdateProfile(body: UpdateProfileRequestDTO): DTOResponse<ProfileDataResponseDTO> {
